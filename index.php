		...
		<div class="content-top">
				<div class="col">
					...
					<div class="content-left">
						<div class="col-md-4" >
							<img src="admin/news_images/<?php echo $n['Anh']; ?>" width="90%" height="30%"/>
						</div>
						<div class="col-md-8">
				...
				<div class="col ">
							...
							?>
								...
								<div class="col-md-4">
									<a target="_blank" href="<?php echo $nm['video_url'];?>"><img src="<?php echo $nm['image'];?>" alt="" width="80%" height="40%"/></a>
								</div>	 
								<div class="col-md-2">
