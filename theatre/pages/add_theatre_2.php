              ...
              <th class="text-right col-md-3"><button data-toggle="modal" data-target="#view-modal" id="getUser" class="btn btn-sm btn-info"><i class="fa fa-plus"></i> Thêm Phòng Chiếu Mới</button></th>
                ...
                while($screen=mysqli_fetch_array($sr))
                {
                  ...
                  <tr>
                    ...
                    ?></td>
                    <td class="text-right"><button data-toggle="modal" data-id="<?php echo $screen['MaPhongChieu'];?>" data-target="#view-modal2" id="getUser2" class="btn btn-sm btn-warning"><i class="fa fa-plus"></i> Thêm thời gian chiếu</button></td>
                  </tr>
                  <?php
                  $sl++;
                }
