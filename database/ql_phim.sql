...
--
-- Host: 127.0.0.1
-- Generation Time: May 28, 2023 at 07:54 AM
...
(4, 4, 'vvanu@gmail.com', '123456789', 2),
(5, 3, 'threater', 'threater', 1);

-- --------------------------------------------------------

--
-- Table structure for table `tbl_datve`
--
...
--
-- Dumping data for table `tbl_datve`
--
...
(3, '', 4, 4, 3, 3, 2, 150000, '2017-05-21', '2017-05-21', 1),
(4, '', 4, 4, 1, 3, 2, 150000, '2017-05-22', '2017-05-22', 1),
(5, '', 3, 3, 6, 1, 1, 70000, '2017-05-25', '2017-05-22', 1),
(6, '', 3, 3, 6, 1, 1, 70000, '2017-05-22', '2017-05-22', 1),
(7, '', 3, 3, 5, 1, 1, 70000, '2017-05-22', '2017-05-22', 1),
(11, 'BKID5258816', 4, 2, 3, 3, 1, 75000, '2017-05-22', '2017-05-22', 1);
...
--
-- Table structure for table `tbl_phimmoi`
--
...
--
-- Dumping data for table `tbl_phimmoi`
--
...
--
-- Table structure for table `tbl_phongchieu`
--
...
--
-- Dumping data for table `tbl_phongchieu`
--
...
--
-- Table structure for table `tbl_rap`
--
...
--
-- Dumping data for table `tbl_rap`
--
...
--
-- Table structure for table `tbl_thoigianchieu`
--
...
--
-- Dumping data for table `tbl_thoigianchieu`
--
...
--
-- Indexes for table `tbl_phimmoi`
--
ALTER TABLE `tbl_phimmoi`
  ADD PRIMARY KEY (`MaPhimMoi`);

--
-- Indexes for table `tbl_phongchieu`
--
...
--
-- Indexes for table `tbl_rap`
--
ALTER TABLE `tbl_rap`
  ADD PRIMARY KEY (`MaRap`);

--
-- Indexes for table `tbl_thoigianchieu`
--
...
--
-- AUTO_INCREMENT for table `tbl_datve`
--
ALTER TABLE `tbl_datve`
  MODIFY `MaDatVe` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT for table `tbl_lichchieu`
--
ALTER TABLE `tbl_lichchieu`
...
--
ALTER TABLE `tbl_phim`
  MODIFY `MaPhim` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `tbl_phimmoi`
--
ALTER TABLE `tbl_phimmoi`
  MODIFY `MaPhimMoi` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `tbl_phongchieu`
--
ALTER TABLE `tbl_phongchieu`
  MODIFY `MaPhongChieu` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `tbl_rap`
--
ALTER TABLE `tbl_rap`
  MODIFY `MaRap` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;

--
-- AUTO_INCREMENT for table `tbl_thoigianchieu`
--
ALTER TABLE `tbl_thoigianchieu`
